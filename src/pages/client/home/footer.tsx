...
const FooterWeb = () => {
    ...
    return (
        <footer id="main-footer" className="sc-4ce82f3c-0 dVnCth">
            <div className="sc-4ce82f3c-1 chWRSJ">
                <div
                    style={{ display: "flex", justifyContent: "space-between" }}
                    className="sc-6d96a9af-0 eTnNSC"
                >
                    <div className="block" style={{ width: 268 }}>
                        ...
                        <a
                            rel="noreferrer"
                            href="https://hotro.tiki.vn/s/article/chinh-sach-doi-tra-san-pham"
                            className="small-text"
                            target="_blank"
                        >
                            Chính sách đổi trả
                    ...
                    <div className="block">
                        <h4 className="sc-4ce82f3c-4 aMfcf">Về Tiki</h4>
                        <a
                            rel="noreferrer"
                    ...
                    <div className="block">
                        ...
                        <h4 style={{ marginTop: 24 }} className="sc-4ce82f3c-4 aMfcf">
                            Chứng nhận bởi
                        </h4>
                        <div className="flex">
                            <a
                            ...
                            <a
                                href="https://www.dmca.com/Protection/Status.aspx?ID=388d758c-6722-4245-a2b0-1d2415e70127&refurl=https://tiki.vn/nha-sach-tiki/c8322"
                    ...
                    <div className="block payment-information">
                            ...
                            <span className="icon">
                                ...
                                >
                                    <defs>
                                        ...
                                        >
                                            <stop stopColor="#004D9B" />
                                            <stop offset={1} stopColor="#002462" />
                                        </radialGradient>
                                        <linearGradient
                                            ...
                                            gradientUnits="userSpaceOnUse"
                                        >
                                            <stop stopColor="#33C3F5" />
                                            <stop offset={1} stopColor="#2241EC" />
                                            <stop offset={1} stopColor="#1D3CE7" />
                                        </linearGradient>
                                    </defs>
                                    <path
                                    ...
                                    >
                                        <rect y={6} width={32} height={20} fill="white" />
                                    </mask>
                        ...
                        <h4 style={{ margin: "24px 0 12px" }} className="sc-4ce82f3c-4 aMfcf">
                            Dịch vụ giao hàng
                        </h4>
                        <p>
                            <a
                                rel="nofollow noreferrer"
                                href="https://tikinow.vn?src=footer"
                                target="_blank"
                            >
                                <img
                    ...
                    <div className="block">
                        ...
                        <h4 className="sc-4ce82f3c-4 aMfcf store-title">
            ...
            <div className="sc-4ce82f3c-3 exPqAC separator" />
            <div className="sc-4ce82f3c-2 eSPDgm">
                <div style={{ display: "flex" }} className="sc-6d96a9af-0 eTnNSC">
                    <div className="address">
                        <i className="tikicon icon-location" />
                        <div className="address-info">
                            <p className="title-text">Công ty TNHH TI KI</p>
            ...
            >
                <div className="sc-4e2e5de4-0 iyhWqm">
                    <div className="sc-4ce82f3c-4 aMfcf">Thương Hiệu Nổi Bật</div>
                    <div className="sc-4e2e5de4-1 bdFUBm">
                        <p style={{ display: "inline-flex", flexWrap: "wrap" }}>
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/vascara.html"
                            >
                                vascara
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/dior.html"
                            >
                                dior
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/estee-lauder.html"
                            >
                                esteelauder
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/th-true-milk.html"
                            >
                                th truemilk
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/barbie.html"
                            >
                                barbie
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/owen.html"
                            >
                                owen
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/ensure.html"
                            >
                                ensure
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/durex.html"
                            >
                                durex
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/bioderma.html"
                            >
                                bioderma
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/elly.html"
                            >
                                elly
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/milo.html"
                            >
                                milo
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/skechers.html"
                            >
                                skechers
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/aldo.html"
                            >
                                aldo
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/triumph.html"
                            >
                                triumph
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/nutifood.html"
                            >
                                nutifood
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/kindle.html"
                            >
                                kindle
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/nerman.html"
                            >
                                nerman
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/wacom.html"
                            >
                                wacom
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/anessa.html"
                            >
                                anessa
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/yoosee.html"
                            >
                                yoosee
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/olay.html"
                            >
                                olay
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/similac.html"
                            >
                                similac
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/comfort.html"
                            >
                                comfort
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/bita-s.html"
                            >
                                bitas
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/shiseido.html"
                            >
                                shiseido
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/l-angfarm.html"
                            >
                                langfarm
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/hukan.html"
                            >
                                hukan
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/vichy.html"
                            >
                                vichy
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/fila.html"
                            >
                                fila
                            </a>
                            &nbsp;/&nbsp;
                            <a
                                style={{ display: "inline" }}
                                href="https://tiki.vn/thuong-hieu/tsubaki.html"
                            >
                                tsubaki
                            </a>
                        </p>
                ...
                <div className="sc-4ce82f3c-3 exPqAC" />
                <div className="sc-8ba33404-0 hrWWOH">
                    <div className="sc-4ce82f3c-4 aMfcf">Danh Mục Sản Phẩm</div>
                    <div className="sc-8ba33404-2 kzdfAZ">
                        <div className="sc-8ba33404-3 kUIXOT">
                            <div className="sc-8ba33404-1 kGhQDb">
                                <div className="sc-4ce82f3c-5 bstmqn">
                                    <a href="https://tiki.vn/do-choi-me-be/c2549">
                                        Đồ Chơi - Mẹ &amp; Bé
                                    </a>
                                </div>
                                <div>
                                    <a href="https://tiki.vn/thoi-trang-cho-me-va-be/c11603">
                                    ...
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/cham-soc-nha-cua/c15078">
                                        Chăm sóc nhà cửa
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/cham-soc-me-mang-thai-sau-sinh/c2640">
                                        Chăm sóc mẹ mang thai, sau sinh
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/dinh-duong-cho-be/c8339">
                                        Dinh dưỡng cho bé
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/ta-bim-cho-be/c2551">Tã, Bỉm</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/dinh-duong-cho-nguoi-lon/c10418">
                                        Dinh dưỡng cho người lớn
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/dinh-duong-cho-me/c10416">
                                        Dinh dưỡng cho mẹ
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/thuc-pham-an-dam/c6568">
                                        Thực phẩm ăn dặm
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/chuan-bi-mang-thai/c10570">
                                        Chuẩn bị mang thai
                                    </a>
                                </div>
                            </div>
                            <div className="sc-8ba33404-1 kGhQDb">
                                ...
                                <div>
                                    <a href="https://tiki.vn/di-cho-online/trai-cay/c44824">
                                        Trái Cây
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/di-cho-online/thit-trung/c54276">
                                        Thịt, Trứng
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/di-cho-online/ca-thuy-hai-san/c54290">
                                        Cá, thuỷ hải sản
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/di-cho-online/rau-cu-qua/c54302">
                                        Rau củ quả
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/di-cho-online/thuc-pham-viet/c54316">
                                        Thực phẩm Việt
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/di-cho-online/sua-bo-pho-mai/c54330">
                                        Sữa, bơ, phô mai
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/di-cho-online/dong-lanh-mat/c54344">
                                        Đông lạnh, mát
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/di-cho-online/dau-an-gia-vi/c54362">
                                        Dầu ăn, gia vị
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/di-cho-online/gao-mi-nong-san/c54384">
                                        Gạo, mì, nông sản
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/di-cho-online/do-hop-dong-goi/c54398">
                                        Đồ hộp, đóng gói
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/di-cho-online/bia-do-uong/c54412">
                                        Bia, đồ uống
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/di-cho-online/thuc-pham-chay/c54430">
                                        Thực phẩm chay
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/di-cho-online/danh-cho-tre-em/c54438">
                                        Dành cho trẻ em
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/di-cho-online/banh-keo-gio-qua/c54452">
                                        Bánh kẹo, giỏ quà
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/di-cho-online/thuc-an-do-thu-cung/c54466">
                                        Thức ăn, đồ thú cưng
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/di-cho-online/cham-soc-ca-nhan/c54474">
                                        Chăm sóc cá nhân
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/di-cho-online/cham-soc-nha-cua/c54500">
                                        Chăm sóc nhà cửa
                                    </a>
                                </div>
                            </div>
                            <div className="sc-8ba33404-1 kGhQDb">
                                <div className="sc-4ce82f3c-5 bstmqn">
                                    <a href="https://tiki.vn/dien-thoai-may-tinh-bang/c1789">
                                ...
                                <div>
                                    ...
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/dien-thoai-pho-thong/c1796">
                            ...
                            <div className="sc-8ba33404-1 kGhQDb">
                                <div className="sc-4ce82f3c-5 bstmqn">
                                    <a href="https://tiki.vn/lam-dep-suc-khoe/c1520">
                                        Làm Đẹp - Sức Khỏe
                                    </a>
                                </div>
                                <div>
                                    <a href="https://tiki.vn/cham-soc-da-mat/c1582">
                                        Chăm sóc da mặt
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/dung-cu-lam-dep/c2306">
                                        Dụng cụ làm đẹp
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/thuc-pham-chuc-nang/c2322">
                                        Thực phẩm chức năng
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/trang-diem/c1584">Trang điểm</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/cham-soc-co-the/c1592">
                                        Chăm sóc cơ thể
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/may-massage-thiet-bi-cham-soc-suc-khoe/c2307">
                                        Máy Massage &amp; Thiết bị chăm sóc sức khỏe
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/san-pham-thien-nhien-khac/c5873">
                                        Sản phẩm thiên nhiên &amp; Khác
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/cham-soc-toc-da-dau/c1591">
                                        Chăm sóc tóc và da đầu
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/cham-soc-ca-nhan/c1594">
                                        Chăm sóc cá nhân
                                    </a>
                                    &nbsp;/&nbsp;<a href="https://tiki.vn/nuoc-hoa/c1595">Nước hoa</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/ho-tro-tinh-duc/c8142">
                                        Hỗ trợ tình dục
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/bo-san-pham-lam-dep/c8161">
                                        Bộ sản phẩm làm đẹp
                                    </a>
                                    &nbsp;/&nbsp;
                            ...
                            <div className="sc-8ba33404-1 kGhQDb">
                                ...
                                <div>
                                    <a href="https://tiki.vn/do-dung-nha-bep/c1884">
                                        Đồ dùng nhà bếp
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/thiet-bi-gia-dinh/c1946">
                                        Thiết bị gia đình
                                    </a>
                                </div>
                            </div>
                        ...
                        <div className="sc-8ba33404-3 kUIXOT">
                            <div className="sc-8ba33404-1 kGhQDb">
                                ...
                                <div>
                                    ...
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/ao-lien-quan-bo-trang-phuc/c1702">
                                        Áo liền quần - Bộ trang phục
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/ao-khoac-nu/c936">Áo khoác nữ</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/do-ngu-do-mac-nha-nu/c1508">
                                        Đồ ngủ - Đồ mặc nhà nữ
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/chan-vay-nu/c5404">Chân váy</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/trang-phuc-boi-nu/c6179">
                                        Trang phục bơi nữ
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/thoi-trang-bau-va-sau-sinh/c49372">
                                        Thời trang bầu và sau sinh
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/thoi-trang-trung-nien/c49384">
                            ...
                            <div className="sc-8ba33404-1 kGhQDb">
                                ...
                                <div>
                                    ...
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/ao-vest-ao-khoac-nam/c925">
                                    ...
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/do-ngu-do-mac-nha-nam/c27570">
                                        Đồ ngủ, đồ mặc nhà nam
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/do-doi-do-gia-dinh-nam/c49516">
                                        Đồ đôi - Đồ gia đình nam
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/ao-ni-ao-len-nam/c4546">
                                        Áo nỉ - Áo len nam
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/do-boi-do-di-bien-nam/c16004">
                                        Đồ bơi - Đồ đi biển nam
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/quan-ao-nam-trung-nien/c49532">
                                        Quần áo nam trung niên
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/quan-ao-nam-kich-co-lon/c49524">
                            ...
                            <div className="sc-8ba33404-1 kGhQDb">
                                ...
                                <div>
                                    ...
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/giay-the-thao-nu/c27604">
                                        Giày thể thao nữ
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/giay-sandals-nu/c4550">
                                        Giày sandals nữ
                                    </a>
                                    &nbsp;/&nbsp;
                                    ...
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/giay-de-xuong-nu/c1008">
                                        Giày Đế xuồng nữ{" "}
                                    </a>
                                </div>
                            </div>
                            <div className="sc-8ba33404-1 kGhQDb">
                                ...
                                <div>
                                    ...
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/giay-the-thao-nam/c27572">
                                        Giày thể thao nam
                                    </a>
                                    &nbsp;/&nbsp;<a href="https://tiki.vn/dep-nam/c5342">Dép nam</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/giay-sandals-nam/c5341">
                                        Giày sandals nam
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/phu-kien-giay-nam/c8338">
                                        Phụ kiện giày nam
                                    </a>
                                    &nbsp;/&nbsp;
                            ...
                            <div className="sc-8ba33404-1 kGhQDb">
                                ...
                                <div>
                                    <a href="https://tiki.vn/tui-deo-cheo-tui-deo-vai-nu/c4558">
                            ...
                            <div className="sc-8ba33404-1 kGhQDb">
                                <div className="sc-4ce82f3c-5 bstmqn">
                                    <a href="https://tiki.vn/tui-thoi-trang-nam/c27616">
                                        Túi thời trang nam
                                    </a>
                                </div>
                                <div>
                                    <a href="https://tiki.vn/vi-nam/c959">Ví nam</a>&nbsp;/&nbsp;
                                    <a href="https://tiki.vn/phu-kien-nam-tui-xach/c958">
                                        Túi đeo chéo nam
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/tui-xach-cong-so-nam/c5337">
                                        Túi xách công sở nam
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/tui-bao-tu-tui-deo-bung/c49650">
                        ...
                        <div className="sc-8ba33404-3 kUIXOT">
                            <div className="sc-8ba33404-1 kGhQDb">
                                ...
                                <div>
                                    ...
                                    <a href="https://tiki.vn/tui-du-lich-va-phu-kien/c8387">
                                        Túi du lịch và phụ kiện
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/balo-cap-tui-chong-soc-laptop/c27612">
                                        Balo, cặp, túi chống sốc laptop
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/vali-phu-kien-vali/c6526">
                                        Vali, phụ kiện vali{" "}
                                    </a>
                                </div>
                            </div>
                            <div className="sc-8ba33404-1 kGhQDb">
                                <div className="sc-4ce82f3c-5 bstmqn">
                                    <a href="https://tiki.vn/phu-kien-thoi-trang/c27498">
                                        Phụ kiện thời trang
                                    </a>
                                </div>
                                <div>
                                    <a href="https://tiki.vn/phu-kien-thoi-trang-nu/c975">
                                        Phụ kiện thời trang nữ
                                    </a>
                                    &nbsp;/&nbsp;<a href="https://tiki.vn/mat-kinh/c8370">Mắt kính</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/phu-kien-thoi-trang-nam/c27550">
                            ...
                            <div className="sc-8ba33404-1 kGhQDb">
                                <div className="sc-4ce82f3c-5 bstmqn">
                                    <a href="https://tiki.vn/dong-ho-va-trang-suc/c8371">
                                ...
                                <div>
                                    ...
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/phu-kien-dong-ho/c27542">
                                        Phụ kiện đồng hồ
                                    </a>
                                    &nbsp;/&nbsp;
                            ...
                            <div className="sc-8ba33404-1 kGhQDb">
                                <div className="sc-4ce82f3c-5 bstmqn">
                                    <a href="https://tiki.vn/laptop-may-vi-tinh-linh-kien/c1846">
                                        Laptop - Máy Vi Tính - Linh kiện
                                    </a>
                                </div>
                                <div>
                                    <a href="https://tiki.vn/linh-kien-may-tinh-phu-kien-may-tinh/c8129">
                                        Linh Kiện Máy Tính - Phụ Kiện Máy Tính
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/thiet-bi-van-phong-thiet-bi-ngoai-vi/c12884">
                                        Thiết Bị Văn Phòng - Thiết Bị Ngoại Vi
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/thiet-bi-mang/c2663">Thiết Bị Mạng</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/thiet-bi-luu-tru/c8060">
                                        Thiết Bị Lưu Trữ
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/pc-may-tinh-bo/c8093">
                                        PC - Máy Tính Bộ
                                    </a>
                            ...
                            <div className="sc-8ba33404-1 kGhQDb">
                                <div className="sc-4ce82f3c-5 bstmqn">
                                    <a href="https://tiki.vn/nha-cua-doi-song/c1883">
                                        Nhà Cửa - Đời Sống
                                    </a>
                                </div>
                                <div>
                                    <a href="https://tiki.vn/trang-tri-nha-cua/c1973">
                                        Trang trí nhà cửa
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/nha-bep/c1951">Dụng cụ nhà bếp</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/sua-chua-nha-cua/c1974">
                                        Sửa chữa nhà cửa
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/ngoai-troi-san-vuon/c2223">
                                        Ngoài trời &amp; sân vườn
                                    </a>
                                    &nbsp;/&nbsp;<a href="https://tiki.vn/noi-that/c2150">Nội thất</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/den-thiet-bi-chieu-sang/c2015">
                                        Đèn &amp; thiết bị chiếu sáng
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/do-dung-va-thiet-bi-nha-tam/c1966">
                                        Đồ dùng và thiết bị nhà tắm
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/phong-an/c1954">Đồ dùng phòng ăn</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/do-dung-phong-ngu/c8313">
                                        Đồ dùng phòng ngủ
                                    </a>
                                    &nbsp;/&nbsp;
                                    ...
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/hoa-tuoi-va-cay-canh/c18852">
                            ...
                            <div className="sc-8ba33404-1 kGhQDb">
                                <div className="sc-4ce82f3c-5 bstmqn">
                                    <a href="https://tiki.vn/bach-hoa-online/c4384">
                                        Bách Hóa Online
                                    </a>
                                </div>
                                <div>
                                    ...
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/do-uong-pha-che-dang-bot/c22998">
                                        Đồ uống - Pha chế dạng bột
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/thuc-pham-dong-hop-va-kho/c15074">
                                        Thực phẩm Đóng hộp và Khô
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/gia-vi-va-che-bien/c4422">
                                        Gia Vị và Chế Biến
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/dau-hat-cac-loai/c53620">
                                        Đậu &amp; Hạt Các Loại
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/do-an-vat/c4421">Đồ Ăn Vặt</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/sua-va-cac-san-pham-tu-sua/c53562">
                                        Sữa và các Sản phẩm từ sữa
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/do-uong-khong-con/c24024">
                                        Đồ Uống Không Cồn
                                    </a>
                                    &nbsp;/&nbsp;
                        ...
                        <div className="sc-8ba33404-3 kUIXOT">
                            <div className="sc-8ba33404-1 kGhQDb">
                                ...
                                <div>
                                    <a href="https://tiki.vn/nha-cua-doi-song/c21268">
                                        Nhà Cửa - Đời Sống
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/thoi-trang/c21442">Thời Trang</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/o-to-xe-may-xe-dap/c21346">
                                        Ô tô, xe máy, xe đạp
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/thiet-bi-so-phu-kien-so/c21382">
                                        Thiết Bị Số - Phụ Kiện Số
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/the-thao-da-ngoai/c21356">
                                        Thể thao - Dã ngoại
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/lam-dep-suc-khoe/c20908">
                                        Làm Đẹp - Sức Khỏe
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/sach-van-phong-pham-qua-luu-niem/c21298">
                                    ...
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/bach-hoa-online/c20766">
                                        Bách hóa online
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/may-anh-may-quay-phim/c21134">
                                        Máy Ảnh - Máy Quay Phim
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/laptop-may-vi-tinh/c21074">
                                        Laptop &amp; Máy Vi Tính
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/san-pham-thiet-bi-cong-nghiep/c25036">
                                        Sản phẩm - thiết bị công nghiệp
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/tivi-thiet-bi-nghe-nhin/c21496">
                                        Tivi &amp; Thiết Bị Nghe Nhìn
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/dien-thoai-may-tinh-bang/c21054">
                                        Điện Thoại - Máy Tính Bảng
                                    </a>
                                </div>
                            </div>
                            <div className="sc-8ba33404-1 kGhQDb">
                                <div className="sc-4ce82f3c-5 bstmqn">
                                    <a href="https://tiki.vn/thiet-bi-kts-phu-kien-so/c1815">
                                        Thiết Bị Số - Phụ Kiện Số
                                    </a>
                                </div>
                                <div>
                                    <a href="https://tiki.vn/phu-kien-dien-thoai-va-may-tinh-bang/c8214">
                                        Phụ Kiện Điện Thoại và Máy Tính Bảng
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/phu-kien-may-tinh-va-laptop/c28670">
                                        Phụ kiện máy tính và Laptop
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/thiet-bi-am-thanh-va-phu-kien/c8215">
                                        Thiết Bị Âm Thanh và Phụ Kiện
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/thiet-bi-thong-minh-va-linh-kien-dien-tu/c28432">
                                        Thiết Bị Thông Minh và Linh Kiện Điện Tử
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/thiet-bi-deo-thong-minh-va-phu-kien/c8039">
                                        Thiết Bị Đeo Thông Minh và Phụ Kiện
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/thiet-bi-choi-game-va-phu-kien/c2667">
                            ...
                            <div className="sc-8ba33404-1 kGhQDb">
                                <div className="sc-4ce82f3c-5 bstmqn">
                                    <a href="https://tiki.vn/voucher-dich-vu/c11312">
                                        Voucher - Dịch vụ
                                    </a>
                                </div>
                                <div>
                                    <a href="https://tiki.vn/san-pham-so/thanh-toan-hoa-don-dien/s1">
                                        Thanh toán hóa đơn
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/khoa-hoc/c11332">Khóa học</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/du-lich-khach-san/c11319">
                                        Du lịch - Khách sạn
                                    </a>
                                    &nbsp;/&nbsp;
                                    ...
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/nha-hang-an-uong/c11313">
                                        Nhà hàng - Ăn uống
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/su-kien-giai-tri/c11327">
                                        Sự kiện - Giải trí
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/nha-khoa-suc-khoe/c11326">
                                        Nha khoa - Sức khỏe
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/phieu-qua-tang/c13744">Phiếu quà tặng</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/san-pham-so/the-cao-dien-thoai">
                            ...
                            <div className="sc-8ba33404-1 kGhQDb">
                                <div className="sc-4ce82f3c-5 bstmqn">
                                    <a href="https://tiki.vn/o-to-xe-may-xe-dap/c8594">
                                        Ô Tô - Xe Máy - Xe Đạp
                                    </a>
                                </div>
                                <div>
                                    <a href="https://tiki.vn/phu-kien-cham-soc-xe/c24832">
                                    ...
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/dich-vu-lap-dat/c17208">
                                        Dịch vụ, lắp đặt
                                    </a>
                                </div>
                            </div>
                            <div className="sc-8ba33404-1 kGhQDb">
                                ...
                                <div>
                                    <a href="https://tiki.vn/sach-truyen-tieng-viet/c316">
                                        Sách tiếng Việt
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/van-phong-pham-qua-luu-niem/c7741">
                                        Văn phòng phẩm
                                    </a>
                                    &nbsp;/&nbsp;
                        ...
                        <div className="sc-8ba33404-3 kUIXOT">
                            <div className="sc-8ba33404-1 kGhQDb">
                                <div className="sc-4ce82f3c-5 bstmqn">
                                    <a href="https://tiki.vn/dien-tu-dien-lanh/c4221">
                                        Điện Tử - Điện Lạnh
                                    </a>
                                </div>
                                <div>
                                    <a href="https://tiki.vn/am-thanh-phu-kien-tivi/c26568">
                                        Âm thanh &amp; Phụ kiện Tivi
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/phu-kien-dien-lanh/c8074">
                                        Phụ kiện điện lạnh
                                    </a>
                                    &nbsp;/&nbsp;<a href="https://tiki.vn/tu-lanh/c2328">Tủ lạnh</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/may-lanh-may-dieu-hoa/c3865">
                                        Máy lạnh - Máy điều hòa
                                    </a>
                                    &nbsp;/&nbsp;<a href="https://tiki.vn/may-giat/c3862">Máy giặt</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/tu-dong-tu-mat/c3868">
                                        Tủ đông - Tủ mát
                                    </a>
                                    ...
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/may-say-quan-ao/c3863">
                                        Máy sấy quần áo
                                    </a>
                                    &nbsp;/&nbsp;
                            ...
                            <div className="sc-8ba33404-1 kGhQDb">
                                <div className="sc-4ce82f3c-5 bstmqn">
                                    <a href="https://tiki.vn/the-thao-da-ngoai/c1975">
                                        Thể Thao - Dã Ngoại
                                    </a>
                                </div>
                                <div>
                                    <a href="https://tiki.vn/trang-phuc-the-thao-nu/c6141">
                                        Trang phục thể thao nữ
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/trang-phuc-the-thao-nam/c6140">
                                        Trang phục thể thao nam
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/do-dung-da-ngoai/c8428">
                                        Đồ dùng dã ngoại
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/giay-the-thao-nam/c6826">
                                        Giày thể thao nam
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/phu-kien-the-thao/c24306">
                                        Phụ kiện thể thao
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/dung-cu-thiet-bi-tap-the-thao/c24128">
                                        Dụng cụ - thiết bị tập thể thao
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/cac-mon-the-thao-khac/c24002">
                                        Các môn thể thao khác
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/dung-cu-cau-ca/c24294">Dụng cụ câu cá</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/the-thao-duoi-nuoc/c8413">
                                        Thể thao dưới nước
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/the-thao-dong-doi/c4227">
                                        Các môn thể thao đồng đội
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/cac-mon-the-thao-choi-vot/c8411">
                                        Các môn thể thao chơi vợt
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/cac-mon-the-thao-doi-khang/c23120">
                                        Các môn thể thao đối kháng{" "}
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/giay-the-thao-nu/c6827">
                                        Giày thể thao nữ
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/thuc-pham-bo-sung-nang-luong/c10803">
                                        Thực phẩm bổ sung năng lượng
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/dung-cu-leo-nui/c24258">
                                        Dụng cụ leo núi
                                    </a>
                                </div>
                            </div>
                            <div className="sc-8ba33404-1 kGhQDb">
                                <div className="sc-4ce82f3c-5 bstmqn">
                                    <a href="https://tiki.vn/may-anh/c1801">
                                        Máy Ảnh - Máy Quay Phim
                                    </a>
                                </div>
                                <div>
                                    <a href="https://tiki.vn/phu-kien-may-anh-may-quay/c1818">
                                        Phụ Kiện Máy Ảnh, Máy Quay
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/camera-giam-sat/c4077">
                                        Camera Giám Sát
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/thiet-bi-anh-sang/c28814">
                                        Thiết Bị Ánh Sáng
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/camera-hanh-trinh-action-camera-va-phu-kien/c28834">
                                        Camera Hành Trình - Action Camera và Phụ Kiện
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/balo-tui-dung-bao-da/c1840">
                                        Balo - Túi Đựng - Bao Da
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/ong-kinh-ong-ngam/c28794">
                                        Ống Kính - Ống Ngắm
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/ong-kinh-lens/c2757">Ống Kính (Lens)</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/thiet-bi-quay-phim/c28822">
                                        Thiết Bị Quay Phim
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/may-bay-camera-va-phu-kien/c8047">
                            ...
                            <div className="sc-8ba33404-1 kGhQDb">
                                ...
                                <div>
                                    <a href="https://tiki.vn/search?q=m%C3%A1y%20s%C6%B0%E1%BB%9Fi%20%E1%BA%A5m%20ph%C3%B2ng%20ng%E1%BB%A7">
                                        máy sưởi
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/den-suoi/c24088">đèn sưởi</a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/search?q=qu%E1%BA%A1t%20s%E1%BA%A1c%20sunhouse">
                                        quạt tích điện sunhouse
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/search?q=m%C3%A1y%20s%E1%BA%A5y%20t%C3%B3c%20philips">
                                        máy sấy tóc philips
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/ban-ui-hoi-nuoc-dung/c1996">
                                        bàn ủi hơi nước đứng
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/search?q=b%C3%A0n%20%E1%BB%A7i%20h%C6%A1i%20n%C6%B0%E1%BB%9Bc%20philips">
                                        bàn là hơi nước philip
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/search?q=s%C6%B0%E1%BB%9Fi%20xiaomi">
                                        may sưởi xiaomi
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/search?q=b%C3%ACnh%20n%C3%B3ng%20l%E1%BA%A1nh%20ariston%2030l">
                                        bình nươc nóng ariston
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/search?q=m%C3%A1y%20s%C6%B0%E1%BB%9Fi%20xiaomi">
                                        máy sưởi xiaomi
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/search?q=m%C3%A1y%20h%C3%BAt%20b%E1%BB%A5i%20gi%C6%B0%E1%BB%9Dng%20n%E1%BB%87m%20xiaomi">
                                        máy hút bụi giường nệm
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/search?q=c%C3%A2y%20n%C6%B0%E1%BB%9Bc%20n%C3%B3ng%20l%E1%BA%A1nh%20toshiba">
                                        cây nước nóng lạnh toshiba
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/search?q=robot%20h%C3%BAt%20b%E1%BB%A5i%20lau%20nh%C3%A0%20nh%E1%BA%ADt%20b%C3%A3i">
                                        robot hút bụi lau nhà của nhật
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/search?q=b%C3%B3ng%20s%C6%B0%E1%BB%9Fi%20%C3%A2m%20tr%E1%BA%A7n">
                                        đèn sưởi âm trần
                                    </a>
                                    &nbsp;/&nbsp;
                                    <a href="https://tiki.vn/noi-com-dien-tu-tefal-rk818a68-1-8l-thuong-hieu-phap-hang-chinh-hang-p198944761.html">
                                        nồi cơm điện tefal
                                    </a>
                                </div>
                            </div>
